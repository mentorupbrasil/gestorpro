...
- Tarefa seguinte: `.env` + migrations P0.1/P0.2 no Supabase; depois P0.3 conclusão médica
- Tarefas concluídas nesta unidade: **P0.2 estação de consulta operacional** (código, migration, 4 testes unitários, build)
