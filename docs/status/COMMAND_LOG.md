...
- Após a consolidação, o Dependabot criou nove branches automáticas de atualização de versão. A configuração foi ajustada para limite zero de PRs de versão, preservando atualizações de segurança; a remoção das branches automáticas existentes ficou condicionada à publicação deste ajuste.
