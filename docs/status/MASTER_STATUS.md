...
| 1 — Plataforma e segurança | IN_PROGRESS | confirmação oficial de stack/versões é a primeira tarefa |
...
| 6 — Triagem e consulta | NOT_STARTED | validação clínica futura |
| 7 — Exames complementares | NOT_STARTED | validação profissional futura |
| 8 — Documentos | NOT_STARTED | modelos/assinatura dependem de humanos |
| 9 — Financeiro e portal | NOT_STARTED | validação contábil/jurídica futura |
...
Branch: `codex/desenvolvimento-completo-unimetra`. Último commit base: `80b07f9`.
